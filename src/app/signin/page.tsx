  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div
        ...
        style={{ backgroundImage: "linear-gradient(to bottom right, #2778E0, #6BE353)" }}
      >
        <div className="text-white flex-1 flex flex-col justify-center items-center space-y-2">
          ...
          <Image src="/assets/signin.png" alt="Signin" width={300} height={300} />
        </div>
        ...
        <div className="flex-1/9 p-8 sm:py-20 rounded-4xl bg-white">
          ...
          <form className="space-y-8" onSubmit={handleLogin}>
            ...
            <div>
              <label className="block font-semibold text-md text-gray-500">Password</label>
              <Input
                type="password"
                value={password}
