  ...
  return (
    <>
      <div className="flex h-[calc(100vh-4rem)] bg-[#EAF1FF]">
        ...
        {/* Chat Section */}
        <div className="w-2/4 xl:w-2/4 flex flex-col justify-center items-center p-6 border  border-r border-gray-200">
          {!selectedUser ? (
...
<div className="hidden xl:block w-1/4 bg-white p-4 border-l border-gray-200">
  ...
  <div className="text-sm text-gray-700 space-y-1 mb-6">
    <p><b>Client:</b> Kate Johnson</p>
    <p><b>Tasker:</b> John Deo</p>
  </div>
  ...
  <div className="bg-gray-50 p-4 rounded-xl shadow-sm">
    <div className="flex items-start gap-4">
      ...
      <div className="flex flex-col justify-center">
        <h3 className="text-gray-800 font-semibold text-base">John Deo</h3>
        ...
        <div className="text-blue-600 text-sm">Electrician | 50+ Jobs</div>
      </div>
    </div>

    
    <p className="text-xs text-gray-600 mt-4">
      Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing Elit. Sed Do Eiusmod Tempor Incididunt.psum Dolor Sit Amet, Consectetur Adipisicing Elit. Sed Do Eiusmod Tempor Incididuntpsum Dolor Sit Amet, Consectetur Adipisicing Elit. Sed Do Eiusmod Tempor Incididunt.
    </p>

   
    <div className="text-green-600 font-semibold mt-4 text-sm">Bids: $350</div>
